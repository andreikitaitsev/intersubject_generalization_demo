...
do
    ...
    do
        ...
        do
            out_dir[$ind]=$out_base$method"/main/"$prepr"/200/time_window13-40/"
            real_files[$ind]=$real_base$method"/main/"$prepr"/200/time_window13-40/shared_test.pkl"
            pred_files[$ind]=$pred_base$method"/main/"$prepr"/200/time_window13-40/Y_test_predicted_"$dtype".pkl"
            dtypes[$ind]=$dtype
            ((ind=ind+1))
        done
    done
