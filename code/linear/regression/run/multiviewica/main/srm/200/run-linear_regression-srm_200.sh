...
# create inputs
# tmp dirs
eeg_dir="/scratch/akitaitsev/intersubject_generalizeation/linear/dataset1/intersubject_generalization/multiviewica/main/srm/200/time_window"
dnn_dir="/scratch/akitaitsev/encoding_Ale/dnn_activations/dataset1/"
out_dir="/scratch/akitaitsev/intersubject_generalizeation/linear/dataset1/regression/multiviewica/main/srm/200/time_window"
