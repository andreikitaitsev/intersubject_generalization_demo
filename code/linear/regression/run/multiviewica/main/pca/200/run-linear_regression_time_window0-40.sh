...
# create inputs
eeg_dir="/scratch/akitaitsev/intersubject_generalizeation/linear/dataset1/intersubject_generalization/multiviewica/mainpca/200//time_window0-40"
dnn_dir="/scratch/akitaitsev/encoding_Ale/dnn_activations/dataset1/"
out_dir="/scratch/akitaitsev/intersubject_generalizeation/linear/dataset1/regression/on_generalized_data/multiviewica/main/time_window0-40/pca_200/"
